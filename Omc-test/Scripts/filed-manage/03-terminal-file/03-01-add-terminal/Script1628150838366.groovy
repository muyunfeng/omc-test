...
'输入终端编号'
WebUI.setText(findTestObject('02_main-page/file-manage/terminal-file/Page_/terminal-number'), GlobalVariable.terminal_number_firse)

'点击主机型号文本框'
WebUI.click(findTestObject('02_main-page/file-manage/terminal-file/Page_/model-number'))

'输入主机型号'
WebUI.setText(findTestObject('02_main-page/file-manage/terminal-file/Page_/model-number'), GlobalVariable.terminal_model_first)
...
WebUI.setText(findTestObject('Object Repository/02_main-page/file-manage/terminal-file/Page_/input__el-input__inner_1_2_3_4_5'), 
    GlobalVariable.terminal_number_firse)

'点击查询\r\n'
WebUI.click(findTestObject('Object Repository/02_main-page/file-manage/terminal-file/Page_/i_ICCID_el-icon-search'))

'点击编辑'
WebUI.click(findTestObject('Object Repository/02_main-page/file-manage/terminal-file/Page_/span__1_2_3'))

'输入终端'
WebUI.setText(findTestObject('02_main-page/file-manage/terminal-file/Page_/terminal-number'), GlobalVariable.terminal_number_second)

'点击空白位'
WebUI.click(findTestObject('Object Repository/02_main-page/file-manage/terminal-file/Page_/p__1'))

'输入型号'
WebUI.setText(findTestObject('02_main-page/file-manage/terminal-file/Page_/model-number'), GlobalVariable.terminal_model_second)
